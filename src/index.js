    ...
    return (
      <div className="AddPart">
        ...
        <form onSubmit={this.handleAddPartFormOnSubmit}>
          <label>Part Name: <input type="text" name="AddPartName" value={this.state.AddPartName} onChange={this.handleAddPartFormChange} required></input></label>
          <label>Date Added: <input type="date" name="AddPartDate" value={this.state.AddPartDate} onChange={this.handleAddPartFormChange}></input></label>
          <label>Part Weight: <input type="number" name="AddPartWeight" value={this.state.AddPartWeight} onChange={this.handleAddPartFormChange}></input></label>
          <button>Add</button>
        </form>
      </div>
    );

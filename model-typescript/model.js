...
class Bike {
    ...
    addPart(newname="apart", newdateinstalled=new Date(), newweight=1, newonbike="on") {
...
class Part {
    constructor(newid, newname="apart", newdateinstalled=new Date(), newweight=1) {
